{
    "0": 
    {
        ...
        "11": ["Заполнить поле", ["Y5008755J", "Y5008754J"], "#txtIdCitado"],
        "12": ["Заполнить поле", ["DANIL RUBIN", "GLEB FEDOROV"], "#txtDesCitado"],
        "13": ["Нажать кнопку", "#btnEnviar"],
        "14": ["Нажать кнопку", "#btnEnviar"],
        "15": ["Заполнить поле", ["612345658", "612345657"], ".cajapeque"],
        "16": ["Заполнить поле", ["612345658a@gmail.com", "612345657a@gmail.com"], "#emailUNO"],
        "17": ["Заполнить поле", ["612345658a@gmail.com", "612345657a@gmail.com"], "#emailDOS"],
...
ФУНКЦИИ КОНСТРУКТОРА И АРГУМЕНТЫ ФУНКЦИЙ
    ...
    -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    {
        "индекс браузера (1)":
        {
            "индекс функции (1)": ["КОМАНДА", "АР", "EУ", "МЕН", "ТЫ"]
            "индекс функции (2)": ["КОМАНДА", "АР", "EУ", "МЕН", "ТЫ"]
            "индекс функции (3)": ["КОМАНДА", "АР", "EУ", "МЕН", "ТЫ"]
            "индекс функции (4)": ["КОМАНДА", "АР", "EУ", "МЕН", "ТЫ"]
        },
        "индекс браузера (2)":
        {
            "индекс функции (1)": ["КОМАНДА", "АР", "EУ", "МЕН", "ТЫ"]
    ...
    3) Выбрать значение -> ["Выбрать значение",  "option_value", "form_selector", "option_selector"] ---- выпадающий список
    ...
    5) Нажать enter -> ["Нажать enter"] - Используется если используем ЭПЦ (тк есть необходимость выбрать подпись)
